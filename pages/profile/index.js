...
export default function Home() {
  return (
    <div className='w-full flex h-screen'>
      ...
      <div className=' w-5/6 px-[141px] max-h-screen overflow-y-auto flex flex-row my-32'>
        <div className='flex flex-col justify-center w-1/2 bg-surfacePrimary rounded-md py-4 my-4 px-2'>
        ...
        <div className='w-1/2 flex flex-col '>
          <div className='h-1/3 bg-surfacePrimary rounded-md px-8 py-4 my-4 mx-4'>
            <p className='text-3xl font-bold pt-4 '>My Roles</p>
          ...
          <div className='h-1/3 bg-surfacePrimary rounded-md py-4 mb-4 mx-4 flex flex-col'>
            <div className='flex justify-between pt-4 px-8 py-4 '>
              <p className='text-3xl font-bold  my-auto'>Rewards</p>
              <Metamask />
            </div>
          ...
          <div className='h-1/3 bg-surfacePrimary rounded-md py-4 mb-4 mx-4 flex flex-col'>
            <div className='flex flex-col pt-4 px-8 py-4'>
              <p className='text-3xl font-bold  my-auto'>Stats</p>
              <div className='my-8'>
